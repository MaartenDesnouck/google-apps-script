...
module.exports = async(fileName, options) => {
    ...
    try {
        ...
        process.stdout.write('Pushing to Google Drive...');
        ...
        if (fileName) {
            process.stdout.write(`Pushing '${metadata.title} > ${fileName}' to Google Drive...`);
        } else {
            process.stdout.write(`Pushing '${metadata.title}' to Google Drive...`);
        }
