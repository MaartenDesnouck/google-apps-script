...
/**
 * Get a token for a the defaut app.
 *
...
function getAuthClient() {
    ...
    const client = new auth.OAuth2(clientId, clientSecret, `${redirectUrl}:${port}`);
...
function authenticate(options) {
    return new Promise((resolve, reject) => {
        ...
        // get Oauth client
        const oauth2ClientResult = getAuthClient();
