    ...
    try {
        ...
        if (deployments.deployments.length > 0) {
            for (const deployment of deployments.deployments) {
                console.log(` [${deployment.deploymentId}]\tversionNumber|${deployment.deploymentConfig.versionNumber}\tmanifestFileName|${deployment.deploymentConfig.manifestFileName}\tdescription|${deployment.description}`);
            }
        }
